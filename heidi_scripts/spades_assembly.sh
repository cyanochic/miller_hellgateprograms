...
apptainer exec --bind /scratch/${netID}/ ${spades} spades.py -1 ${fwd} -2 ${rvs} --meta -o ${output}
...
mkdir ${output}quast
apptainer exec --bind /scratch/${netID}/ ${quast} quast.py ${output}${prefix}_scaf_filtered.fasta -o ${output}quast/ -t 16
